...
@section('content')
    ...
    <div class="text-center text-white bg-indigo-600 py-4">
        ...
        <div class="py-12 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                سجلـ/ى الآن معنا واحصل علي فرصة عمل قريبة منك ورواتب مجزية
                </p>
                </div>
        ...
        <div class="bg-gray-50">
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
                ...
                <div class="inline-flex rounded-md shadow">
                    <a href="{{route('profiles.register_form')}}" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                    فورم التسجيل
                    </a>
                </div>
