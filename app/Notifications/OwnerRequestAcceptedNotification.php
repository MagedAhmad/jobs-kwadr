...
class OwnerRequestAcceptedNotification extends Notification
{
    use Queueable;
    ...
    public function toFCM($notifiable)
    {
        return (new FCMMessage())
            ->setData([
                ...
                'body' => trans('owner_requests.messages.accepted'),
                'view' => [
                    'id' => $this->ownerRequest->id,
                    'type' => 'owner_request_accepted',
    ...
    {
        return [
            'title' => trans('owner_requests.messages.accepted'),
            'message' =>  $this->ownerRequest->business_name . " " .trans('owner_requests.messages.accepted'),
        ];
    }
}
